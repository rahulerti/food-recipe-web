...
function moreDesctoWelcome() {
    const moreDesctoWelcome_content =
        ...
        <span class="st"> <span class="emoji">🌟</span> Step into a world where flavors dance and aromas enchant – welcome to food world where every recipe is a journey and every dish tells a story. We're delighted to have you here, ready to embark on a culinary adventure like no other.
        </span>
        <span class="st"><span class="emoji">🍲</span> we're more than just a collection of recipes; we're a community of food enthusiasts, passionate about sharing the joy of cooking. Whether you're a seasoned chef or a kitchen newbie, our diverse array of recipes caters to every taste, skill level, and craving.
        </span>
        ...
        <span class="st"><span class="emoji">🍽️</span> Join us in celebrating the art of cooking, every meal is an opportunity to create something extraordinary. Get ready to embark on a culinary journey that tantalizes your taste buds and inspires your inner chef.</span>
